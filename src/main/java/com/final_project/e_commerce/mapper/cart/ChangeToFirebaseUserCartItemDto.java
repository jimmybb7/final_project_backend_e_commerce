...
public interface ChangeToFirebaseUserCartItemDto {
    //normal method
...
//    }
    ...
    //mapstruct method
    ResponseFirebaseUserCartItemDto changeFirebaseUserCartItemDomainToResponseFirebaseUserCartItemDto(ResponseFirebaseUserCartItemDomain responseFirebaseUserCartItemDomain);

    List<ResponseFirebaseUserCartItemDto> changeFirebaseUserCartItemDomainToResponseFirebaseUserCartItemDtoList(List<ResponseFirebaseUserCartItemDomain> responseFirebaseUserCartItemDomainList);
